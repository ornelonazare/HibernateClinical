...
import com.example.restservice.repository.invoice.InvoiceRepository;
...
public class InvoiceController {
    ...
    public ResponseEntity<Invoice> createInvoice(@RequestBody Invoice invoice) {
        try {
            ...
            invoiceRepository.save(_invoice);
    ...
    public ResponseEntity<Invoice> updateInvoice(@PathVariable("id") int id, @RequestBody Invoice invoice) {
        ...
        if (invoiceData.isPresent()) {
            ...
            if (invoice.getPatient_invoice() != null) {
                _invoice.setPatient_invoice(invoice.getPatient_invoice());
            }
    ...
    /*@GetMapping("/invoices/patient/patientname")
    public ResponseEntity<Invoice> getInvoiceByPatientId(@RequestBody Patient patient) {



        Optional<Invoice> invoiceData = invoiceRepository.findByPatientname(patient.getName());
