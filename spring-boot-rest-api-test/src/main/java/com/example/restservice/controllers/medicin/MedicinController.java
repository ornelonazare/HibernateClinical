...
public class MedicinController {
    ...
    public ResponseEntity<Medicin> getMedicinById(@PathVariable("medicinid") int medicinid) {
    ...
    public ResponseEntity<HttpStatus> deleteMedicin(@PathVariable("id") int id) {
        try {
